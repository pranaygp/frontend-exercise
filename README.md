...
This project was bootstrapped using [Create React App](https://github.com/facebookincubator/create-react-app). The following were added in addition to what is generated by default:
